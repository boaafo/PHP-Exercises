...
*/
$greeting = "Welcome to " . $language . "!" . "<br>";
/*
Print greeting.
*/
...
*/
$assembled = "My name is $firstName. I was born on the $day of $month in $year.";
/*
Print assembled.
*/
...
*/
$deliveryFee = $price * $delivery;
$taxes = $price * $tax;

$total = $price + $deliveryFee + $taxes;
/*
Concatenate the variables and string literals to print the statement:
armchair: $295.44
*/
$productFormat = "$product: " . "$" . number_format((float)$total, 2, '.', '');
echo $productFormat;
...
echo "<figcaption>$productFormat</figcaption>";
echo "</figure>";
